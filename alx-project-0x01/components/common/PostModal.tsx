...
const PostModal: React.Fc<PostModalProps> = ({ onClose, onSubmit}) => {
    ...
    return (
        <div className="fixed onset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center">
            <div className="bg-white rounded-lg p-8 shadow-lg w-full max-w-md">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        ...
                        <input type="number" id="userId" name="userId" value={post.userId} onChange={handleChange} className="w-full
